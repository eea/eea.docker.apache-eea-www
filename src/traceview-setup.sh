...
apt-get update
apt-get install -y --no-install-recommends liboboe0 liboboe-dev tracelyzer libapache2-mod-oboe build-essential cmake
...
apt-get purge -y --auto-remove libapache2-mod-oboe apache2 build-essential
apt-get clean
