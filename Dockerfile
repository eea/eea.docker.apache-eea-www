...
RUN runDeps=" curl libsys-syslog-perl apt-transport-https ca-certificates" \
 ...
 && mkdir -p /usr/local/apache2/conf/extra/ /var/eea-buildout-plone4/etc/apache /var/eea-buildout-plone4/etc/scripts /var/local/www-logs/eea /var/local/www-logs/pagespeed /var/www/html /var/www-static-resources/ /var/cache/mod_pagespeed \
