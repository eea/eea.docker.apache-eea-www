...
RUN runDeps=" curl libsys-syslog-perl apt-transport-https ca-certificates" \
 ...
 && mkdir -p /usr/local/apache2/conf/extra/ /var/eea-buildout-plone4/etc/apache /var/eea-buildout-plone4/etc/scripts /var/local/www-logs/eea /var/local/www-logs/pagespeed /var/www/html /var/www-static-resources/ /var/local/www-logs/pagespeed_cache \
 ...
 && mv /tmp/vh-www-pagespeed.conf /usr/local/apache2/conf/extra/ \
